...
# Training settings
    ...
    parser.add_argument('--data_dir', type=str, default='/home/ztm/dataset/vimeo_septuplet/sequences')
    parser.add_argument('--file_list', type=str, default='/home/ztm/dataset/vimeo_septuplet/sep_trainlist.txt')
